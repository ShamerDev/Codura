...
<div>
    <div
        ...
        <div>
            <div
                class="max-w-7xl mx-auto px-6 py-12 bg-white/10 backdrop-blur-lg rounded-lg shadow-lg relative z-10">
                @if ($entries->isNotEmpty())
                    <!-- Entries Grid -->
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        @foreach ($entries as $entry)
                            <div
                                class="group bg-white/80 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden hover:scale-[1.02] hover:-translate-y-2">
                                <!-- Image Container -->
                                <div class="relative overflow-hidden">
                                    @if ($entry->thumbnail_path)
                                        <div
                                            class="aspect-video bg-gradient-to-br from-slate-200 to-slate-300 relative">
                    ...
                    <div class="text-center py-20">
                        <div class="max-w-lg mx-auto">
                            ...
                            <p class="text-slate-600 mb-8 text-lg leading-relaxed">
                                Your portfolio is waiting for your first project. Start showcasing your coding skills
                                and
