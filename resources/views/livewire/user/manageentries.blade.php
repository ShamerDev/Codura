        ...
        @else
            <div class="space-y-6">
                @foreach ($entries as $entry)
                    <div class="flex items-center justify-between bg-gray-50 border rounded-xl p-4 shadow-sm hover:shadow-md transition">
                            ...
                            <label class="flex items-center cursor-pointer">
                                ...
                                <div class="w-12 h-6 bg-gray-300 rounded-full shadow-inner relative">
                                    <div class="dot absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition
                                        {{ $entry->is_public ? 'translate-x-6 bg-green-500' : '' }}">
                                    </div>
                                </div>
                            </label>
