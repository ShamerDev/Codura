    ...
    <div
        ...
        <div class="relative z-10 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white backdrop-blur-sm overflow-hidden shadow-2xl sm:rounded-xl">
                ...
                <div
                    class="bg-gradient-to-r from-indigo-600 to-purple-600 backdrop-blur-sm rounded-lg p-4 m-6 border border-fuchsia-300/50 shadow-lg shadow-fuchsia-500/20">
                    <div class="flex items-center space-x-2 mb-4">
                        <div class="bg-white p-2 rounded-lg shadow-md">
                            <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                        ...
                        <h3 class="text-lg font-bold text-white tracking-wide">Skill Insights</h3>
                    </div>
                    <livewire:main.skill-insights />
                </div>
