<x-app-layout>
    ...
    <div class="relative py-12 bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute top-20 left-10 bg-white/20 backdrop-blur-sm rounded-lg p-3 shadow-lg animate-bounce" style="animation-delay: 0s; animation-duration: 6s;">
            ...
            <div class="absolute top-40 right-20 bg-white/30 backdrop-blur-sm rounded-lg p-3 shadow-lg animate-bounce" style="animation-delay: 2s; animation-duration: 8s;">
                <div class="text-xs font-mono text-gray-600">
            ...
            <div class="absolute bottom-32 left-20 bg-white/25 backdrop-blur-sm rounded-lg p-3 shadow-lg animate-bounce" style="animation-delay: 4s; animation-duration: 7s;">
                <div class="text-xs font-mono text-gray-600">
            ...
            <!-- Floating Tech Icons -->
            <div class="absolute top-60 left-32 bg-white/30 backdrop-blur-sm p-2 rounded-full shadow-lg animate-pulse" style="animation-duration: 3s;">
                <svg class="w-6 h-6 text-blue-500" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/>
                </svg>
            </div>

            <div class="absolute top-80 right-40 bg-white/30 backdrop-blur-sm p-2 rounded-full shadow-lg animate-pulse" style="animation-delay: 1s; animation-duration: 4s;">
            ...
            <!-- Geometric Shapes -->
            <div class="absolute top-32 right-60 w-16 h-16 border-2 border-blue-300/50 rounded-lg rotate-45 animate-spin" style="animation-duration: 20s;"></div>
            <div class="absolute bottom-40 right-32 w-12 h-12 border-2 border-purple-300/50 rounded-full animate-ping" style="animation-duration: 5s;"></div>
            <div class="absolute top-96 left-60 w-8 h-8 bg-gradient-to-r from-cyan-400/30 to-blue-500/30 rounded transform rotate-12 animate-pulse"></div>
            ...
            <svg class="absolute inset-0 w-full h-full" style="z-index: -1;">
                ...
                <path d="M 100 200 Q 400 100 800 300" stroke="url(#lineGradient)" stroke-width="2" fill="none" opacity="0.3">
                    <animate attributeName="stroke-dasharray" values="0,1000;1000,1000;0,1000" dur="8s" repeatCount="indefinite"/>
                </path>
                <path d="M 200 600 Q 600 400 1200 500" stroke="url(#lineGradient)" stroke-width="2" fill="none" opacity="0.2">
                    <animate attributeName="stroke-dasharray" values="1000,0;0,1000;1000,0" dur="10s" repeatCount="indefinite"/>
                </path>
            </svg>

            <!-- Particle System -->
            <div class="absolute top-20 left-1/4 w-1 h-1 bg-blue-400 rounded-full animate-ping" style="animation-delay: 0s;"></div>
            <div class="absolute top-40 left-3/4 w-1 h-1 bg-purple-400 rounded-full animate-ping" style="animation-delay: 1s;"></div>
            <div class="absolute bottom-60 left-1/2 w-1 h-1 bg-cyan-400 rounded-full animate-ping" style="animation-delay: 2s;"></div>
            <div class="absolute bottom-40 left-1/3 w-1 h-1 bg-green-400 rounded-full animate-ping" style="animation-delay: 3s;"></div>
        </div>
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <style>
                ...
                .rain-column { animation: rain linear infinite; }
                .rain-1 { animation-duration: 8s; animation-delay: 0s; }
                .rain-2 { animation-duration: 12s; animation-delay: 2s; }
                .rain-3 { animation-duration: 10s; animation-delay: 4s; }
                .rain-4 { animation-duration: 15s; animation-delay: 1s; }
                .rain-5 { animation-duration: 9s; animation-delay: 3s; }
                .rain-6 { animation-duration: 11s; animation-delay: 5s; }
                .rain-7 { animation-duration: 13s; animation-delay: 6s; }
                .rain-8 { animation-duration: 7s; animation-delay: 2.5s; }
            </style>
        ...
        <div class="relative z-10 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/90 backdrop-blur-sm overflow-hidden shadow-2xl sm:rounded-xl border border-white/30">
                <div class="flex space-x-8 p-6">
                    <!-- Chart Component -->
                    <div class="flex-1 bg-gradient-to-br from-gray-50/80 to-blue-50/80 backdrop-blur-sm rounded-lg p-4 border border-gray-100/50">
                    ...
                    <!-- Info Box Component -->
                    <div class="w-1/2 bg-gradient-to-br from-purple-50/80 to-pink-50/80 backdrop-blur-sm rounded-lg p-4 border border-gray-100/50">
                        <div class="flex items-center space-x-2 mb-4">
